...
borg prune --keep-daily 7 --keep-weekly 4 --keep-monthly 1 --glob-archives 'pg_sql*' borg@192.168.122.39:postgres_repo
...
borg prune --keep-daily 7 --keep-weekly 4 --keep-monthly 1 --glob-archives 'example*' borg@192.168.122.39:postgres_repo
